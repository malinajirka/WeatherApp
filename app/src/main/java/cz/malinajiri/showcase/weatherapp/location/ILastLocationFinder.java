...
public interface ILastLocationFinder {
	 ...
	 * location to be returned using the {@link android.location.LocationListener} passed in
	 * through {@link cz.malinajiri.showcase.weatherapp.listener.OnLocationChangedListener}
	 * 
	 * @param minDistance
	 ...
	 */
	public Location getLastBestLocation(float minDistance, long minTime) throws LocationNotFoundException;

	/**
	 * Set the {@link android.location.LocationListener} that may receive a one-shot current
	 * location update.
	 * 
	 * @param l
	 *            LocationListener
